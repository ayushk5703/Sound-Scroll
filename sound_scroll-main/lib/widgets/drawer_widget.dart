      ...
      child: ListView(
        ...
        children: [
          ...
          ListTile(
            ...
            title: const Text('+91 9631743321'),
            onTap: () async {
              if (!await launchUrl(Uri.parse("tel:+91 9631743321"))) {
          ...
          ListTile(
            ...
            title: const Text('miss.ayushk5703@gmail.com'),
            onTap: () async {
              if (!await launchUrl(
                  Uri.parse("mailto:miss.ayushk5703@gmail.com"))) {
                throw Exception('Could not launch"');
              }
            },
          ),
